...
type Entry struct {
	...
	// Raw message bytes for messages that are not proto.Messages, such as the
	// mem.BufferSlice produced by a custom gRPC codec (e.g. the zero-copy codec
	// the GCS client installs for ReadObject). When set, message is unset and the
	// bytes are replayed verbatim. Mutually exclusive with message.
...
func (x *Entry) GetRawMessage() []byte {
	if x != nil {
		return x.RawMessage
	}
	return nil
...
var file_grpcreplay_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb4, 0x02, 0x0a, 0x05, 0x45, 0x6e,
	...
	0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x72, 0x65, 0x66, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12,
	0x1f, 0x0a, 0x0b, 0x72, 0x61, 0x77, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x72, 0x61, 0x77, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x22, 0x5e, 0x0a, 0x04, 0x4b, 0x69, 0x6e, 0x64, 0x12, 0x14, 0x0a, 0x10, 0x54, 0x59, 0x50, 0x45,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x67, 0x6f, 0x2d, 0x72, 0x65, 0x70, 0x6c, 0x61, 0x79, 0x65,
	0x72, 0x73, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x72, 0x65, 0x70, 0x6c, 0x61, 0x79, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x72, 0x65, 0x70, 0x6c, 0x61, 0x79, 0x62, 0x06,
...
var file_grpcreplay_proto_goTypes = []any{
...
func file_grpcreplay_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_grpcreplay_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Entry); i {
			case 0:
				return &v.state
			case 1:
